...
export function ErrorAlert() {
	const { dismissError } = useContext(AlertContext);

  return (
		<div className="alert comic-alert cursor-pointer fixed flex flex-row items-center bg-red-200 p-5 rounded border-b-2 border-red-300" onClick={dismissError}>
